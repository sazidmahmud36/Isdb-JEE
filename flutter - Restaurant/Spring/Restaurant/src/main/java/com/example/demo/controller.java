...
public class controller {
	...
	@PostMapping("/newbooking2")
	public void newBooking2(@RequestBody Booking2 b) {
	...
	public List<Booking> allBookedTableByDate() {
		BookingDA da = new BookingDA();
		return da.allbooked();
	}
...
//		System.out.println(b);
	...
	List<User> showAllUser = new ArrayList<>();
	@GetMapping("/alluser")
	public List<User> getAllUser() {
		UserDA da = new UserDA();
		showAllUser = da.getAllUser();
	...
	public User signinStudent(@RequestBody User u) {
		UserDA d = new UserDA();
//		User st=d.userSigninById(u.admin_id);
		User userSigninById = d.userSigninById(u.admin_id);
		System.out.print("login");
		return userSigninById;
	}
	
	@PostMapping(value="/customerLogin")
	public CustomerLogin signinCustomer(@RequestBody CustomerLogin u) {
		CustomerLoginDA d = new CustomerLoginDA();
//		User st=d.userSigninById(u.admin_id);
		CustomerLogin customerSigninById = d.customerSigninById(u.customer_id);
		System.out.print("login");
		return customerSigninById;
	}
	
	List<CustomerLogin> showAllCustomer = new ArrayList<>();
	@GetMapping("/allCustomer")
	public List<CustomerLogin> getAllCustomerLogin() {
		CustomerLoginDA da = new CustomerLoginDA();
		showAllCustomer = da.getAllCustomerLogin();
